...
ALLOWED_TASKS = {"observer", "sentinel", "amplifier", "mirror", "polymorph", "archivist", "conductor"}
BANNED_PATTERNS = ["deception", "surveillance", "mind control", "thelema", "malware", "disinfo"]
